 ...
 */
public class DosDocente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar datos Docente");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        con.RegistroDoc(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), pass, jTextField6.getText(), Integer.parseInt(jTextField7.getText()), jTextField5.getText());
        Limpiar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DosDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DosDocente().setVisible(true);
            }
        });
    }
